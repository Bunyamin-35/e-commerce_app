...
const Dahsboard = () => {
    ...
    return (
        <>
            {/* <Navbar /> */}
            {/* <div classNameName="flex overflow-hidden bg-white">
                <Sidebar />
            ...
            {/* <div classNameName="dashboard_content">
                <div classNameName="left_bar">
                    <div classNameName="user_info">
                        <h2>User Info</h2>
                        <span>{username}</span>
                    </div>
                    <div classNameName="order_info">
                        <h2>Order Info</h2>
                                    ...
                                    <div className="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
                                        ...
                                        <div className="flow-root">
                                            <ul className="divide-y divide-gray-200">
                                                {users?.map((user, key) => <li key={key} className="py-3 sm:py-4">
