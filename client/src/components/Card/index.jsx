                ...
                <div className="mt-4 px-5 pb-5">
                    ...
                    {!modal &&
                        <a rel="noopener noreferrer"
                            href="/#" onClick={() => dispatch(handleAddtoCart({ ...item, userId: parseJwt(token).userId}))} className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
